...
public class Constants {
	...
	public static final String SELLER_TABLE_NAME = "seller_details";
	public static final String BUYER_TABLE_NAME = "buyer_details";
	public static final String CATEGORY_TABLE_NAME = "category_details";
	public static final String SUB_CATEGORY_TABLE_NAME = "sub_category_details";
	...
	public static final String NO_PASSWORD_EXISTS = "No Password Exists";
