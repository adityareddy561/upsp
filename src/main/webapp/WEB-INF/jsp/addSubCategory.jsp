					...
					<div class="row">
						...
						<div class="col-sm-6" style=" margin:0 auto;
							...
							<form id="myForm2">
								...
								<select id="chooseCat"
									style="margin-right: 30px; border-radius: 4px; padding: 7px;
									border-radius: 6px; font-size: 16px; background: #fbfbfb; border: 2px
									solid transparent; padding-left: 20px; padding-right: 20px;
									padding-bottom: 5px; padding-top: 5px; height: 36px; box-shadow: 0 0 0
									1px #dddddd, 0 2px 4px 0 rgb(0 0 0/ 7%), 0 1px 1.5px 0 rgb(0 0 0/ 5%);
