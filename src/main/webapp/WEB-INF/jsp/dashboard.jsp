	...
	<div
		...
		<div class="app-main">
				...
				<div class="scrollbar-sidebar">
					<div class="app-sidebar__inner">
						<ul class="vertical-nav-menu">
							...
							<li class="mm-active">
								<button id="addCat" class="button-3" role="button"
									onclick="addCategory();">Add Category</button>
							</li>
							<li class="mm-active" style="margin-top: 20px;">
								<button id="addSubCat" class="button-3" role="button"
									onclick="addSubCategory();">Add Sub category</button>
							</li>
			...
			<div class="app-main__outer">
				...
				<form id="myForm"
					style="display: none; padding-left: 500px; background-color: #bbc7c6;">
					<!-- Form fields and inputs go here -->
					<input type="text" placeholder="Name" id="input1"
						class="categoryName2"><br> <input class="button-91"
				...
				<form id="myForm2"
					...
					<!-- Form fields and inputs go here -->
					<select id="chooseCat"
						style="margin-right: 30px; border-radius: 4px; padding: 7px; border-radius: 6px; font-size: 16px; background: #fbfbfb; border: 2px solid transparent; padding-left: 20px; padding-right: 20px; padding-bottom: 5px; padding-top: 5px; height: 36px; box-shadow: 0 0 0 1px #dddddd, 0 2px 4px 0 rgb(0 0 0/ 7%), 0 1px 1.5px 0 rgb(0 0 0/ 5%); : focus { border : 2px solid #000;">
						<option value="">Select category</option>
					</select> <input type="text" placeholder="Name" id="input1"
						class="SubcategoryName2"><br> <input
						class="button-91" type="submit" value="Add"
						onclick="addSubCategoryByAdmin();"
